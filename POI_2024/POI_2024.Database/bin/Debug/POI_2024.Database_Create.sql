/*
Deployment script for POI_2024_2
...
GO
:setvar DatabaseName "POI_2024_2"
:setvar DefaultFilePrefix "POI_2024_2"
...
GO
PRINT N'Creating Table [dbo].[StatusTareas]...';


GO
CREATE TABLE [dbo].[StatusTareas] (
    [IDStatusTarea] INT IDENTITY (1, 1) NOT NULL,
    [IDTarea]       INT NULL,
    [Matricula]     INT NULL,
    [Status]        INT NULL,
    PRIMARY KEY CLUSTERED ([IDStatusTarea] ASC)
);
...
GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[StatusTareas]...';


GO
ALTER TABLE [dbo].[StatusTareas]
    ADD FOREIGN KEY ([IDTarea]) REFERENCES [dbo].[Tareas] ([ID_Tareas]);
