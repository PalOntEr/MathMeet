...
const IncomingMessage = ({ Emote, message, sender, DateSent,Archive }) => {
    ...
    return (
        <div className="incoming-message-container bg-comp-1 rounded-md w-1/3 px-3 py-2 m-3">
            ...
            <img className="incoming-message-content text-color" src={"data:image/*;base64," + Archivo.contenido}></img>
